...
const GrpcMetadataList = require('../property-lists/grpc-metadata-list');
...
class BrunoGrpcResponse {
  ...
  constructor(response, { message } = {}) {
    ...
    this.metadata = new GrpcMetadataList(() => toMetadataObject(this.#response.metadata));
    this.trailers = new GrpcMetadataList(() => toMetadataObject(this.#response.trailers));
